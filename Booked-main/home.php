...
<body>
  ...
  <section class="home_cont">
    <div class="main_descrip">
      <h1>Booked</h1>
      <p>Browse, Search, and Buy Your Favorite Books</p>
  ...
  <section class="about_cont">
    <img src="about.jpg" alt="https://images.unsplash.com/photo-1502700807168-484a3e7889d0?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
    <div class="about_descript">
      <h2>Our Booked Journey</h2>
      <p>At Booked, "More than pages — we’re a place where stories live, minds grow, and curiosity is always welcome."
    </p>
  ...
  <section class="questions_cont">
    ...
    <p>We’d love to hear from you! Whether you’re looking for a specific title, need help with an order, or just want to ask us something book-related — we’re here to help..</p>
